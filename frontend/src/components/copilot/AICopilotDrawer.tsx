      ...
      >
        ...
        <div className="p-3.5 sm:p-4 border-b border-voltron-750/80 flex items-center justify-between bg-voltron-900/60 backdrop-blur">
          ...
          <button
            ...
            className="p-1.5 rounded-lg text-voltron-400 hover:text-white hover:bg-voltron-800 transition-colors focus:outline-none focus-visible:ring-2 focus-visible:ring-voltron-cyan"
            title="Close Copilot"
          >
            <X className="w-5 h-5" />
          </button>
        ...
        <div className="p-3 border-t border-voltron-750/80 bg-voltron-900/80 backdrop-blur">
          ...
          >
            ...
            <button
              ...
              className="absolute right-2 p-1.5 rounded-md bg-voltron-cyan text-voltron-950 hover:bg-voltron-cyan-dim disabled:opacity-40 disabled:hover:bg-voltron-cyan transition-colors min-h-[32px] min-w-[32px] flex items-center justify-center"
              title="Send Message"
            >
